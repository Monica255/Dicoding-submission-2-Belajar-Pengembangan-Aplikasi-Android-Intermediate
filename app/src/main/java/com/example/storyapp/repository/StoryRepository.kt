...
import com.example.storyapp.data.StoryRemotMediator
...
class StoryRepository(
    ...
    var storiess: LiveData<List<ListStory>> = _stories
    ...
    fun getPagingStories(token: String): LiveData<PagingData<ListStoryPaging>> {
        val pager = Pager(
            ...
            remoteMediator = StoryRemotMediator(storyDatabase, apiService, token),
            pagingSourceFactory = {
